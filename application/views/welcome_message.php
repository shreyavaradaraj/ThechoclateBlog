...
<html>
	<head>
		...
		<style type="text/css">
			...
			#page { background-image: url("http://www.siwallpaperhd.com/wp-content/uploads/2016/02/melted_chocolate_wallpaper_desktop.jpg");
	...
	<body>
		<div id="page">
			...
			<div class="feature">
				...
				<h1>Learn all about Choclates</h1>
				</div>
			</div>
			...
			<div id="content">
				<div id="content-inner">
					...
					<main id="contentbar">
						<div class="article">
							<img src="http://www.thefoodieskitchen.com/wp-content/uploads/chocolate-bars-400-300x300.jpg" alt="Smiley face" width="600" height="500">
								
							<?php foreach ($query->result() as $row):?>
								<h3><?=$row->entry_heading?></h3>
								<p><?=$row->entry_text?></p>
							<hr>
							<?php endforeach; ?>
						</div>
			...
			<footer id="footer">
				<div id="footer-inner">
					<p>&copy; Copyright <a href="#">shreyablog.com</a> &#124; <a href="#">Terms of Use</a> &#124; <a href="#">Privacy Policy</a></p>
					<div class="clr"></div>
				</div>
			</footer>
		</div>
